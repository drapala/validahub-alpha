...
from src.application.idempotency.store import IdempotencyConflictError, InMemoryIdempotencyStore
...
class TestJobsHttpHandler:
    ...
    def test_submit_job_no_pii_leakage_in_errors(self):
        ...
        self.mock_use_case.execute.side_effect = ValidationError(
...
class TestHttpJobSubmissionResponse:
    ...
    def test_to_dict_new_request(self):
        ...
        expected = {
            ...
            "file_ref": "s3://bucket/file.csv",
            "created_at": "2023-12-01T10:00:00Z",
            "meta": {"idempotency_key": "key123", "request_id": "req_123", "is_replay": False},
        }
...
class TestHeaderExtraction:
    ...
    def test_header_unicode_handling(self):
        ...
        unicode_headers = {"Idempotency-Key": "key-🔑-test", "X-Request-Id": "req-ñ-123"}
    ...
    def test_header_null_byte_handling(self):
        ...
        null_byte_headers = {"Idempotency-Key": "key\x00admin", "X-Request-Id": "req\x00123"}
