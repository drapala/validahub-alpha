...
class DopplerClient:
    ...
    def __init__(self, config: Optional[DopplerConfig] = None):
        """
    ...
    def _get_cli_token(self) -> Optional[str]:
...
class SecretsManager:
    ...
    def __init__(self, doppler_client: Optional[DopplerClient] = None):
        """
    ...
    def get_jwt_keys(self) -> tuple[str, Optional[str]]:
        """
