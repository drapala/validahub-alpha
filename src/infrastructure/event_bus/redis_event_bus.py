...
class InMemoryEventBus(EventBus, LoggingPort):
            ...
            for subscriber in subscribers:
                try:
                    ...
                    self._logger.debug(
                        ...
                        event_id=event_id,
                        event_type=event_type,
                        subscriber=subscriber.__name__ if hasattr(subscriber, '__name__') else str(subscriber),
                        correlation_id=get_correlation_id()
                    )
    ...
    def get_events(self, tenant_id: Optional[str] = None, limit: int = 100) -> List[Dict[str, Any]]:
        """
