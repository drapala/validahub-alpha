...
class CanonicalCSVModel:
    ...
    def validate_field(self, field_name: str, value: Any) -> CCMValidationResult:
        ...
        if value is None or (isinstance(value, str) and value.strip() == ""):
            if field_def.required:
                ...
                return CCMValidationResult(
                    field=field_name, is_valid=True, original_value=value, normalized_value=None
                )
    ...
    def transform_from_marketplace(
        self, data: pd.DataFrame, marketplace_mapping: dict[str, str]
    ) -> pd.DataFrame:
        """
    ...
    def _validate_string(self, field_def: CCMField, value: Any) -> CCMValidationResult:
        ...
        return CCMValidationResult(
            field=field_def.name, is_valid=True, original_value=value, normalized_value=str_value
        )
    ...
    def _validate_decimal(self, field_def: CCMField, value: Any) -> CCMValidationResult:
        ...
        try:
            ...
            if (
                field_def.name in ["weight_kg", "length_cm", "width_cm", "height_cm"]
                and decimal_value < 0
            ):
                return CCMValidationResult(
                    field=field_def.name,
    ...
    def _validate_boolean(self, field_def: CCMField, value: Any) -> CCMValidationResult:
        ...
        if isinstance(value, bool):
            return CCMValidationResult(
                field=field_def.name, is_valid=True, original_value=value, normalized_value=value
            )
        ...
        if isinstance(value, str):
            ...
            if str_value in ["true", "1", "yes", "sim", "verdadeiro"]:
                return CCMValidationResult(
                    field=field_def.name, is_valid=True, original_value=value, normalized_value=True
                )
    ...
    def _validate_array(self, field_def: CCMField, value: Any) -> CCMValidationResult:
        ...
        return CCMValidationResult(
            field=field_def.name, is_valid=True, original_value=value, normalized_value=array_value
        )
